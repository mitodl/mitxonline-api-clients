...
**course** | **number** |  | [optional] [default to undefined]
**program** | **number** |  | [optional] [default to undefined]
**required_program** | **number** |  | [optional] [default to undefined]
...
```typescript
import { V2ProgramRequirementData } from './api';

const instance: V2ProgramRequirementData = {
    node_type,
    course,
    program,
    required_program,
