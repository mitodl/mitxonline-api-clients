...
**products** | [**Array&lt;ProductFlexibilePrice&gt;**](ProductFlexibilePrice.md) | List of products associated with this course run | [readonly] [default to undefined]
**approved_flexible_price_exists** | **boolean** |  | [readonly] [default to undefined]
**course** | [**Course**](Course.md) |  | [readonly] [default to undefined]

## Example

```typescript
import { V1CourseRunWithCourse } from './api';

const instance: V1CourseRunWithCourse = {
    title,
    start_date,
    end_date,
    enrollment_start,
