...
**products** | [**Array&lt;ProductFlexibilePrice&gt;**](ProductFlexibilePrice.md) |  | [readonly] [default to undefined]
**approved_flexible_price_exists** | **boolean** |  | [readonly] [default to undefined]

## Example

```typescript
import { V1BaseCourseRun } from './api';

const instance: V1BaseCourseRun = {
    title,
    start_date,
    end_date,
    enrollment_start,
