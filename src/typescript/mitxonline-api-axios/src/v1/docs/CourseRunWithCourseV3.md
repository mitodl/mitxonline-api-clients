...
**courseware_url** | **string** | Get the courseware URL | [readonly] [default to undefined]
...
**is_upgradable** | **boolean** | Check if the course run is upgradable | [readonly] [default to undefined]
**is_enrollable** | **boolean** | Check if the course run is enrollable | [readonly] [default to undefined]
**is_archived** | **boolean** | Check if the course run is archived | [readonly] [default to undefined]
...
**course_number** | **string** | Get the course number | [readonly] [default to undefined]
**enrollment_modes** | **Array&lt;{ [key: string]: any; }&gt;** | Get the enrollment modes for the course run | [readonly] [default to undefined]
...
**language_label** | **string** | Return the label for the language, using the override if necessary | [readonly] [default to undefined]
...
**course_id** | **number** |  | [readonly] [default to undefined]
**upgrade_product_id** | **number** |  | [readonly] [default to undefined]
**upgrade_product_price** | **string** |  | [readonly] [default to undefined]
**upgrade_product_is_active** | **boolean** |  | [readonly] [default to undefined]
**course** | [**CourseV3**](CourseV3.md) |  | [readonly] [default to undefined]

## Example

```typescript
import { CourseRunWithCourseV3 } from './api';

const instance: CourseRunWithCourseV3 = {
    title,
    start_date,
    end_date,
    enrollment_start,
