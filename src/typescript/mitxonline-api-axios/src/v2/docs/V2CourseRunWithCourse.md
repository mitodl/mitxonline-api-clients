...
**products** | [**Array&lt;BaseProduct&gt;**](BaseProduct.md) |  | [readonly] [default to undefined]
**approved_flexible_price_exists** | **boolean** |  | [readonly] [default to undefined]
**b2b_contract** | **number** |  | [optional] [default to undefined]
**course** | [**V2Course**](V2Course.md) |  | [readonly] [default to undefined]

## Example

```typescript
import { V2CourseRunWithCourse } from './api';

const instance: V2CourseRunWithCourse = {
    title,
    start_date,
    end_date,
    enrollment_start,
